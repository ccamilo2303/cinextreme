...
export const environment = {
  ...
  payUconfig: {
    ...
    responseUrl: 'http://localhost/payu-raw-master/respuesta.php', // URL de respuesta,
    confirmationUrl: 'http://localhost/payu-raw-master/respuesta.php', // URL de confirmación
  },
  ...
  configuracionPlanBasico : {
    ...
    referenceCode: 'bsasssis30test@testcom', // Referencia Unica del pedido
